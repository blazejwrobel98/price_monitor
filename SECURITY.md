...
Dla wersji self-hosted pamiętaj, że aplikacja wykonuje żądania HTTP pod adresy zdefiniowane przez użytkownika — hostuj ją tam, gdzie akceptujesz ten poziom zaufania (sieć wychodząca, brak uwierzytelniania wbudowanego w 0.0.2).
